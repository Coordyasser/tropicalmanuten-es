...
import { LayoutDashboard, LogOut, Plus, Wrench } from 'lucide-react'
...
function Sidebar({ onNovoTicket, onSignOut, userName }: SidebarProps) {
  return (
    <aside className="w-60 shrink-0 bg-slate-900 text-white flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-blue-600/20 text-blue-400 text-sm font-medium">
