...
export default function DashboardTecnico() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      {/* Header */}
      <header className="bg-gradient-to-r from-blue-700 to-blue-600 text-white px-4 pt-10 pb-6 shadow-lg">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-blue-200 text-xs font-medium uppercase tracking-widest mb-1">Ola,</p>
            <h1 className="text-xl font-bold leading-tight">{profile?.name ?? 'Tecnico'}</h1>
          </div>
